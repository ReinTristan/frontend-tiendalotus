  ...
  return (
    <div className="flex items-center justify-between mb-2">
      ...
      <div className="flex flex-col items-center ml-2">
        <span className="font-bold">${(10).toFixed(2)}</span> {/* Precio del objeto, se asume un precio fijo de 10 */}
        <div className="flex items-center  mt-1">
          ...
          <span className="border-t border-b border-black px-2">{item.quantity}</span>
          <button 
            onClick={onAdd} 
...
export default function Header() {
  ...
  const [cartItems, setCartItems] = useState([
    { id: 1, name: 'Producto 1', quantity: 1, image: 'https://via.placeholder.com/150' },
    { id: 2, name: 'Producto 2', quantity: 2, image: 'https://via.placeholder.com/150' },
  ]);
              ...
              <div className="p-4 text-lg">
                ...
                <div className="flex justify-between font-bold my-2">
                  ...
                  <span className="text-right">
                    <span className="text-stone-500">USD</span> ${total.toFixed(2)}
                  </span>
                </div>
