...
export default function Home() {
	...
	return (
		<div className='min-h-screen flex flex-col bg-black'>
			...
			<div
				className='mt-10 text-center text-white text-4xl font-inria px-96 font-bold'
				id='contacto'
				ref={contactRef}
			>
			...
			>
				...
				<div className='bg-stone-500 bg-opacity-85 px-10 py-10 rounded-2xl shadow-lg w-1/4 mr-10 text-white font-inria text-2xl'>
					{' '}
					{/* Tarjeta con campos de texto y botón */}
					{/* Campos de texto y botón organizados verticalmente */}
					<form className='flex flex-col space-y-10' onSubmit={handleContacto}>
						{' '}
